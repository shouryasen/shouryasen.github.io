...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/book_fieldwork_motorbike.jpg" class="img-fluid rounded z-depth-1" caption="On the road to field sites. Author's photo." %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/book_hand_drawn_map.jpg" class="img-fluid rounded z-depth-1" caption="A hand-drawn map of local village geography c. 1950s, shared by a community elder. Author's photo." %}
    </div>
</div>
