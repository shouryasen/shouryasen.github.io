...
{% include figure.liquid path="assets/img/book_fieldwork_boat.jpg" class="img-fluid rounded z-depth-1" caption="Fieldwork in upland Laos. Author's photo." %}
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/book_fieldwork_motorbike.jpg" class="img-fluid rounded z-depth-1" caption="On the road to field sites." %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/book_fieldwork_bridge.jpg" class="img-fluid rounded z-depth-1" caption="A bamboo bridge in one of the book's fieldwork areas." %}
    </div>
</div>
